...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected virtual void MoveGrabbedObject(Vector3 pos, Quaternion rot, bool forceTeleport = false)
    {
        ...
        Quaternion finalRotation = grabbableRotation * Quaternion.Euler(addRot);
        ...
        if (forceTeleport)
        {
            try
            {
                ...
                grabbedRigidbody.transform.rotation = finalRotation;
            }
            catch
            {
                //print("Whoopsie!!!");
        ...
        else
        {
            try {
                ...
                //octodad
                grabbedRigidbody.MoveRotation(finalRotation);
